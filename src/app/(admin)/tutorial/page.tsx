        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Login terlebih dahulu menggunakan akun yang sudah terdaftar. Jika
              belum memiliki akun, silakan lakukan registrasi terlebih dahulu
              melalui halaman pendaftaran.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600">
              Setelah berhasil login, klik menu <strong>Ticket</strong> pada
              navigasi utama.
            </p>
          </div>
          ...
          <div>
            <h2 className="text-xl font-semibold mb-2">
              4. Pilih Kategori Ticket
            </h2>
            <p className="text-gray-600 mb-2">
              Pilih salah satu dari 3 kategori ticket berikut:
            </p>
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-600 mt-2 space-y-1">
              ...
              <li>
                Jika memilih <strong>Ticket Komunitas</strong>, isi data diri
                penanggung jawab serta data anggota komunitas.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600">
              Pilih metode pembayaran yang tersedia, kemudian lanjutkan proses
              pembayaran sesuai instruksi yang diberikan.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-600 mt-2 space-y-1">
              ...
              <li>
                Jika ingin menukar ticket fisik, datang ke lokasi penukaran yang
